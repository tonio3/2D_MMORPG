...
namespace SimpleFolderIcon.Editor
{
    ...
    {
        private const string AssetsPath = "EditorTools/Packages/SimpleFolderIcon/Icons";
        ...
        internal static void BuildDictionary()
        {
            ...
            {
                var texture = (Texture)AssetDatabase.LoadAssetAtPath($"Assets/EditorTools/Packages/SimpleFolderIcon/Icons/{f.Name}", typeof(Texture2D));
            ...
            {
                var folderIconSO = (FolderIconSO)AssetDatabase.LoadAssetAtPath($"Assets/EditorTools/Packages/SimpleFolderIcon/Icons/{f.Name}", typeof(FolderIconSO));
